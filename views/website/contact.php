...
<body class="overflow-x-hidden">
    <section class="relative h-screen flex items-center justify-start bg-cover bg-center" style="background-image: url('/public/assets/images/bgcontact.jpg');">
        <!-- Overlay -->
        ...
        <div class="relative z-10 max-w-3xl px-6 lg:px-20">
            <h1 class="text-5xl md:text-6xl font-bold text-white leading-tight">
                ...
                <div class="mb-3 text-orange-400">We’re Here to Care for You</div>
            </h1>

            <p class="mt-6 text-base text-gray-200">
                Have questions or need assistance? Reach out to Animocare — our team is always ready to help with your pet’s health and wellness needs.
            </p>
        </div>
    </section>
