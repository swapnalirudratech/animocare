...
<body class="overflow-x-hidden">
    <section class="relative h-screen flex items-center justify-start bg-cover bg-center" style="background-image: url('/public/assets/images/6.jpg');">
        <!-- Overlay -->
    ...
    <section class="w-full mx-auto px-6 py-20">
        ...
        <div class="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-8 w-[80%] max-md:w-[90%] mx-auto">
            ...
            <div class="bg-white h-full rounded-2xl shadow-sm p-6 hover:shadow-lg transition flex flex-col justify-between">
                ...
                <img src="/public/assets/images/banner1.jpg" alt="Global Sourcing" class="rounded-xl h-56 w-full object-cover mt-auto" />
            </div>
            ...
            <div class="bg-white h-full rounded-2xl shadow-sm p-6 hover:shadow-lg transition flex flex-col justify-between">
                ...
                <img src="/public/assets/images/s2.jpg" alt="International Shipping" class="rounded-xl h-56 w-full object-cover mt-auto" />
            </div>
            ...
            <div class="bg-white h-full rounded-2xl shadow-sm p-6 hover:shadow-lg transition flex flex-col justify-between">
                ...
                <img src="/public/assets/images/s4.jpg" alt="Customs & Compliance" class="rounded-xl h-56 w-full object-cover mt-auto" />
            </div>
            ...
            <div class="bg-white h-full rounded-2xl shadow-sm p-6 hover:shadow-lg transition flex flex-col justify-between">
                ...
                <img src="/public/assets/images/s5.jpg" alt="Sustainable Sourcing" class="rounded-xl h-56 w-full object-cover mt-auto" />
            </div>
            ...
            <div class="bg-white h-full rounded-2xl shadow-sm p-6 hover:shadow-lg transition flex flex-col justify-between">
                ...
                <img src="/public/assets/images/s6.jpg" alt="Food & Commodity Trading" class="rounded-xl h-56 w-full object-cover mt-auto" />
            </div>
        </div>
