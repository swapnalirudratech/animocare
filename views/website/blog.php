...
<body class="overflow-x-hidden">
    ...
    <section class="w-[70vw] mx-auto px-4 py-16 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2 gap-10 space-y-10">
            ...
            ?>
                <article class="bg-white rounded-lg border border-gray-200 overflow-hidden">
                    <img src="<?= $blog['blog_img'] ?>" alt="Blog Image" class="w-full h-64 object-cover">
                    <div class="p-6">
                        ...
                        <a href="/<?= $url ?>" class="inline-flex items-center text-orange-500 font-medium hover:underline">
        ...
        <aside class="space-y-10">
            ...
            <div class="bg-gray-100 rounded-md p-8">
                ...
                <div class="flex flex-wrap gap-2">
                    <a href="#" class="bg-gray-200 text-gray-700 px-3 py-1 rounded hover:bg-orange-500 hover:text-white">Shipping</a>
                    <a href="#" class="bg-gray-200 text-gray-700 px-3 py-1 rounded hover:bg-orange-500 hover:text-white">Export</a>
                    <a href="#" class="bg-gray-200 text-gray-700 px-3 py-1 rounded hover:bg-orange-500 hover:text-white">Trade</a>
                    <a href="#" class="bg-gray-200 text-gray-700 px-3 py-1 rounded hover:bg-orange-500 hover:text-white">Environment</a>
                </div>
            </div>
        </aside>
    </section>
