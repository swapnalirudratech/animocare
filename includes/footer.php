 ...
 <footer class="relative bg-black text-gray-300">
     ...
     <div class="absolute inset-0">
         <img src="/assets/images/footer.jpg" alt="Footer Background" class="w-full h-full object-cover opacity-20">
     </div>
         ...
         <div class="border-t border-gray-700 pt-10 grid md:grid-cols-3 gap-10">
             ...
             <div class="grid grid-cols-2 gap-6">
                 ...
                 <ul class="space-y-3 text-sm">
                     ...
                     <li><a href="#" class="hover:text-white">F.A.Q</a></li>
                     <li><a href="#" class="hover:text-white">Privacy Policy</a></li>
                     <li><a href="#" class="hover:text-white">Feedbacks</a></li>
