...
<body class="overflow-x-hidden">
    <!-- Hero Section -->
    <section class="relative h-screen flex items-center justify-start bg-cover bg-center" style="background-image: url('/assets/images/banner2.png');">
        <!-- Overlay -->
        ...
        <div class="w-[80%] mx-auto px-6 lg:px-0 relative z-10">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-10">
                ...
                <div class="relative overflow-hidden rounded-2xl group">
                    <img src="/assets/images/1.jpg" alt="Quality Assurance" class="w-full h-full object-cover rounded-2xl transition-transform duration-300 group-hover:scale-105">
                ...
                <!-- Secure Packaging -->
                <div class="relative overflow-hidden rounded-2xl group">
                    <img src="/assets/images/2.jpg" alt="Secure Packaging" class="w-full h-full object-cover rounded-2xl transition-transform duration-300 group-hover:scale-105">
                    <div class="absolute inset-0 bg-black bg-opacity-70 flex flex-col justify-end items-start p-6 
                opacity-0 translate-y-full group-hover:translate-y-0 group-hover:opacity-100 
                transition-all duration-500 ease-in-out rounded-2xl">
                        <div class="bg-orange-500 text-white px-2 py-1 text-sm rounded mb-3 font-semibold">
                ...
                <div class="relative overflow-hidden rounded-2xl group">
                    <img src="/assets/images/3.jpg" alt="Logistics" class="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105">
                    <div class="absolute inset-0 bg-black bg-opacity-70 flex flex-col justify-end items-start p-6 
                opacity-0 translate-y-full group-hover:translate-y-0 group-hover:opacity-100 
